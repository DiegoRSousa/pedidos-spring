...
CREATE TABLE PEDIDO (
    ...
    CHECK (TOTAL = (SUBTOTAL + ACRESCIMO - DESCONTO))
);

INSERT INTO PEDIDO (NUMERO, DATA, CLIENTE_ID, SUBTOTAL, ACRESCIMO, DESCONTO, TOTAL, CRIADO_EM)
...
CREATE TABLE PRODUTOPEDIDO (
    ...
    CHECK (SUBTOTAL = (PRECO * QUANTIDADE))
);

INSERT INTO PRODUTOPEDIDO (QUANTIDADE, PRECO, SUBTOTAL, PRODUTO_ID, PEDIDO_ID) VALUES (3, 15.00, 45.00, 1, 1);
INSERT INTO PRODUTOPEDIDO (QUANTIDADE, PRECO, SUBTOTAL, PRODUTO_ID, PEDIDO_ID) VALUES (1, 5.00, 5, 2, 1);
INSERT INTO PRODUTOPEDIDO (QUANTIDADE, PRECO, SUBTOTAL, PRODUTO_ID, PEDIDO_ID) VALUES (2, 25.00, 50, 3, 1);
