...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.diego.pedidosspring.controllers"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API do projeto de estudos de Spring Boot",
				"Esta API é utilizada para patricar desenvolvimento com a stack Spring", "Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Diego Sousa", "https://github.com/DiegoRSousa/pedidos-spring", 
						"diegors90@gmail.com"), "",  "", Collections.emptyList()
		);
	}
